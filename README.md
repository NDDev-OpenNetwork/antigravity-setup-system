...
instructions, skills, agents, commands, hooks, MCP entries, plugins and settings together, in one step.
...
docker run --rm -v "$HOME/.config:/config" \
  ghcr.io/nddev-opennetwork/antigravity-setup-system:0.0.49 \
