...
Everything below is generated from the baseline and cannot go stale against
the declaration. This file is hand-written and can, which is why two of its
paragraphs above now carry the date they were corrected.
